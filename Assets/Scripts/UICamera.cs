...
public class UICamera : MonoBehaviour
{
	...
	public static bool disableController
	{
		get
		{
			return UICamera.mDisableController && UIPopupList.current == null;
		}
		set
		{
	...
	private void Update()
	{
		...
		if ((this.useKeyhelm || this.useController) && !UICamera.disableController)
		{
			this.ProcessOthers();
		}
		...
		if (Input.anyKeyDown)
		{
			...
			while (i < num3)
			{
				...
				if (keyCode != keyCode2)
				{
					...
					{
						if (this.useKeyhelm || keyCode2 >= KeyCode.Mouse0)
						{
