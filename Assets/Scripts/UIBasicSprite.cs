...
public abstract class UIBasicSprite : UIWidget
{
	...
	private void HalfFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		verts.Add(new Vector3(drawingDimensions.x, drawingDimensions.y));
		verts.Add(new Vector3(drawingDimensions.x, drawingDimensions.w));
		verts.Add(new Vector3((drawingDimensions.z + drawingDimensions.x) * 0.5f, drawingDimensions.w));
		verts.Add(new Vector3((drawingDimensions.z + drawingDimensions.x) * 0.5f, drawingDimensions.y));
		verts.Add(new Vector3((drawingDimensions.z + drawingDimensions.x) * 0.5f, drawingDimensions.y));
		verts.Add(new Vector3((drawingDimensions.z + drawingDimensions.x) * 0.5f, drawingDimensions.w));
		verts.Add(new Vector3(drawingDimensions.z, drawingDimensions.w));
		verts.Add(new Vector3(drawingDimensions.z, drawingDimensions.y));
